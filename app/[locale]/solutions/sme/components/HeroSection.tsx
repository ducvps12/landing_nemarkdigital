    ...
    return (
        ...
        >
            ...
            <div className="absolute inset-0 overflow-hidden">
                ...
                <div className="absolute bottom-20 right-20 w-60 h-60 bg-[#F5C518]/10 rounded-full blur-3xl"></div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                    ...
                    <div className="flex flex-col gap-6" data-aos="fade-right">
                        ...
                        <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full w-fit">
                            ...
                            <span className="text-white/90 text-sm font-medium">Giải pháp cho SME</span>
                        </div>

                        {/* Main Heading */}
                        <h1 className="text-white text-3xl md:text-4xl lg:text-5xl font-extrabold leading-tight tracking-tight">
                            Giải Pháp Chuyển Đổi Số Toàn Diện Cho SME{' '}
                            <span className="text-[#F5C518] block mt-2">Kiến Tạo Nền Tảng - Bứt Phá Doanh Thu</span>
                        </h1>

                        {/* Animated line */}
                        <div className="flex items-center gap-2">
                            <div className="h-0.5 w-16 bg-[#F5C518]"></div>
                            <span className="text-white/70 text-sm italic">
                                Website - App Mobile - Hệ Quản lý
                            </span>
                        ...
                        <p className="text-white/90 text-base md:text-lg leading-relaxed max-w-xl">
                            Nemark cung cấp hệ sinh thái công nghệ trọn gói bao gồm:{' '}
                            <span className="font-semibold text-[#F5C518]">Website - App Mobile - Hệ Quản lý</span>,
                            giúp doanh nghiệp vừa và nhỏ (SME) đạt được các mục tiêu kinh doanh, tối ưu giảm chi phí và tiết kiệm nỗ lực vận hành để tập trung phát triển sản phẩm.
                        </p>

                        {/* Stats */}
                        <div className="grid grid-cols-3 gap-4 max-w-xl">
                            <div className="bg-white/10 backdrop-blur-sm p-4 rounded-xl border-2 border-white/30 text-center hover:bg-white/20 transition-all">
                                <div className="text-[#F5C518] text-4xl md:text-5xl font-black mb-1">6+</div>
                                <div className="text-white/90 text-xs font-medium leading-tight">Năm kinh nghiệm triển khai</div>
                            </div>
                            <div className="bg-white/10 backdrop-blur-sm p-4 rounded-xl border-2 border-white/30 text-center hover:bg-white/20 transition-all">
                                <div className="text-[#F5C518] text-4xl md:text-5xl font-black mb-1">100+</div>
                                <div className="text-white/90 text-xs font-medium leading-tight">Dự án triển khai thành công</div>
                            </div>
                            <div className="bg-white/10 backdrop-blur-sm p-4 rounded-xl border-2 border-white/30 text-center hover:bg-white/20 transition-all">
                                <div className="text-[#F5C518] text-4xl md:text-5xl font-black mb-1">98%</div>
                                <div className="text-white/90 text-xs font-medium leading-tight">Khách hàng hài lòng</div>
                            </div>
                        </div>
                        ...
                        <button
                            ...
                            className="group px-8 py-4 bg-[#F5C518] hover:bg-[#e6b615] text-[#0077B6] font-bold rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 uppercase tracking-wider text-sm flex items-center justify-center gap-2 max-w-xs"
                        >
                            Tư Vấn Giải Pháp SME
                        ...
                        <div className="relative">
                            ...
                            <div className="relative bg-white/10 backdrop-blur-sm rounded-3xl p-6 border border-white/20">
                                <div className="relative w-[300px] h-[300px] sm:w-[350px] sm:h-[350px] md:w-[400px] md:h-[400px] lg:w-[450px] lg:h-[450px]">
                                    ...
                                    {/* Floating badges */}
                                    <div className="absolute -top-4 -right-4 bg-[#F5C518] text-[#0077B6] px-4 py-2 rounded-full font-bold text-sm shadow-lg animate-float">
                                        Build Fast
                                    </div>
                                    <div className="absolute -bottom-4 -left-4 bg-white text-[#0077B6] px-4 py-2 rounded-full font-bold text-sm shadow-lg animate-float" style={{ animationDelay: '0.5s' }}>
                                        Scale Fast
                                    </div>
                                </div>
                            </div>

...
export default function ProcessSection() {
    const steps = [
        {
            number: 1,
            title: 'Đánh giá lỗ hổng & Rủi ro bảo mật',
            position: 'top'
        },
        {
            number: 2,
            title: 'Lập kế hoạch bảo mật chi tiết',
            position: 'bottom'
        },
        {
            number: 3,
            title: 'Cấu hình Firewall & Hardening',
            position: 'top'
        },
        {
            number: 4,
            title: 'Triển khai hệ thống giám sát',
            position: 'bottom'
        },
        {
            number: 5,
            title: 'Kiểm thử xâm nhập (Pen Test)',
            position: 'top'
        },
        {
            number: 6,
            title: 'Bàn giao & Đào tạo nhân sự',
            position: 'bottom'
        }
    ]

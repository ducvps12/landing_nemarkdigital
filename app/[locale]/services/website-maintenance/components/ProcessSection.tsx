...
export default function ProcessSection() {
    const steps = [
        ...
        {
            number: 2,
            title: 'Sao lưu Dữ liệu & Quét Virus',
            position: 'bottom'
        },
        {
            number: 3,
            title: 'Tối ưu Tốc độ & Hiệu năng',
            position: 'top'
        },
        {
            number: 4,
            title: 'Cập nhật Nội dung & Sản phẩm',
            position: 'bottom'
        },
        {
            number: 5,
            title: 'Giám sát Uptime & Xử lý sự cố 24/7',
            position: 'top'
        },
        {
            number: 6,
            title: 'Báo cáo Định kỳ & Tư vấn Phát triển',
            position: 'bottom'
        }
    ]
            ...
            <div className="max-w-7xl mx-auto px-4 lg:px-8">
                ...
                <div className="text-center mb-16" data-aos="fade-up">
                    <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold uppercase tracking-wide">
                        ...
                        <span className="text-red-700">Bảo Trì</span>
                    </h2>
                </div>
                        ...
                        {steps.map((step, index) => (
                            ...
                            >
                                ...
                                <div className="flex-1 bg-white rounded-xl shadow-md p-4 border border-gray-100">
                                    <h4 className="text-accent-dark font-bold text-sm mb-1">
                                        Bước {step.number}
                                    </h4>

...
export default function ProblemsSection() {
    const problems = [
        'Quy trình thủ công & Tốn kém nhân sự',
        'Dữ liệu rời rạc, thiếu đồng bộ',
        'Khách hàng bỏ ngang vì thanh toán rườm rà',
        'Lãng phí tài nguyên Dữ liệu Khách hàng'
    ]
            ...
            <div className="max-w-7xl mx-auto px-4 lg:px-8">
                ...
                <div className="text-center mb-12" data-aos="fade-up">
                    <h2 className="text-2xl md:text-3xl lg:text-4xl font-extrabold text-gray-800 mb-4">
                        Vấn đề các doanh nghiệp <span className="text-primary">đang gặp phải</span>
                    </h2>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="flex justify-center" data-aos="fade-left">
                        <div className="relative">
                            <div className="absolute -inset-4 bg-gradient-to-br from-primary-light/30 to-accent-light/30 rounded-2xl blur-xl opacity-50"></div>

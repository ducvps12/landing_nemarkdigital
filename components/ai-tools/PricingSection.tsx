...
export default function PricingSection({ onOpenContactModal }: PricingSectionProps) {
    const t = useTranslations('aiToolsPage.pricing')
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="mt-12 text-center" data-aos="fade-up">
                    <p className="text-gray-500 text-sm">
                        💡 {t('extraNote')} <span className="font-semibold text-gray-700">{t('extraTools')}</span>
                        <button onClick={onOpenContactModal} className="text-primary font-semibold ml-1 hover:underline">{t('extraCta')}</button>
                    </p>
                </div>
            </div>
        </section>
